...
jl_datatype_t *jl_tuplemap_entry_type;
jl_datatype_t *jl_tuplemap_level_type;
...
jl_tuplemap_level_t *jl_new_tuplemap_level(void)
{
    jl_tuplemap_level_t *cache = (jl_tuplemap_level_t*)jl_gc_allocobj(sizeof(jl_tuplemap_level_t));
    jl_set_typeof(cache, jl_tuplemap_level_type);
    cache->key = NULL;
    cache->linear = (jl_tuplemap_entry_t*)jl_nothing;
