...
union jl_tuplemap_t {
    struct _jl_tuplemap_level_t *node;
    struct _jl_tuplemap_entry_t *leaf;
...
typedef struct _jl_tuplemap_entry_t {
    JL_DATA_TYPE
    struct _jl_tuplemap_entry_t *next; // invasive linked list
...
typedef struct _jl_tuplemap_level_t {
    JL_DATA_TYPE
    jl_array_t *arg1; // Array{union jl_tuplemap_t}
    jl_array_t *targ; // Array{union jl_tuplemap_t}
    jl_tuplemap_entry_t *linear; // union jl_tuplemap_t (but no more levels)
...
typedef struct _jl_methtable_t {
    JL_DATA_TYPE
    jl_sym_t *name;
    union jl_tuplemap_t defs;
    union jl_tuplemap_t cache;
...
extern JL_DLLEXPORT jl_datatype_t *jl_tuplemap_level_type;
extern JL_DLLEXPORT jl_datatype_t *jl_tuplemap_entry_type;
