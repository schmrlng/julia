...
void jl_init_types(void)
{
    ...
    jl_tuplemap_level_type =
        jl_new_datatype(jl_symbol("TupleMapLevel"), jl_any_type, jl_emptysvec,
    ...
    jl_tuplemap_entry_type =
        jl_new_datatype(jl_symbol("TupleMapEntry"), jl_any_type, jl_emptysvec,
    ...
    jl_compute_field_offsets(jl_tuplemap_level_type);
    jl_compute_field_offsets(jl_tuplemap_entry_type);
