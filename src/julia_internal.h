...
typedef int (*jl_tuplemap_visitor_fptr)(jl_tuplemap_entry_t *l, void *closure);
int jl_tuplemap_visitor(union jl_tuplemap_t a, jl_tuplemap_visitor_fptr fptr, void *closure);
