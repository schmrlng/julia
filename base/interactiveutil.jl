...
function methodswith(t::Type, f::Function, showparents::Bool=false, meths = TupleMapEntry[])
    mt = typeof(f).name.mt
    visit(mt) do d
...
function summarysize(m::TupleMapEntry, seen, excl)
    size::Int = 0
